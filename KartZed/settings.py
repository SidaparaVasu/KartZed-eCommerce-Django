"""
Django settings for KartZed project.
...
SECRET_KEY = 'django-insecure-u9w)-81))-=bvvz^ma*&qb+l0%jco+lrw)&0+m@kfc5lxocz(g'
...
WSGI_APPLICATION = 'KartZed.wsgi.application'
...
EMAIL_HOST_PASSWORD = 'mlpl hbkm zsua emyy'
