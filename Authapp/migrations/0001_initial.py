# Generated by Django 4.1 on 2023-05-02 20:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='UserBalancePoints',
            fields=[
                ('points_id', models.AutoField(primary_key=True, serialize=False)),
                ('points', models.IntegerField()),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Authapp.customers')),
            ],
        ),
    ]
